...
<link rel="stylesheet" href="https://www.w3schools.com/w3css/4/w3.css">
    ...
    <body>
	    ...
	    $qry = getListOfContactUs();//display all car
                ...
                //delete menu
                        echo '<td>';
			            echo '<form action="../Admin/processcontactus.php" method="POST" >';
			            ...
			            echo '<form action="../Admin/processcontactus.php" method="POST" >';
			            echo "<input type='hidden' value='$name' name='nameToDelete'>";
			            echo '<input type="submit" name="deleteAllButtonStaff" value="Delete">';
			            echo '</form>';
                        echo '</td>';
