...
$sql = "select * from customer where username ='$searchValue'";
echo $sql;
$qry = mysqli_query($con,$sql);//run query
return $qry;  //return query
}
...
if(!$con)
	...
	$searchValue=$_POST['searchValue'];
$sql = "select * from customer where email='$searchValue'";
echo $sql;
$qry = mysqli_query($con,$sql);//run query
return $qry;  //return query
}
...
if(!$con)
 ...
 $email = $_POST['emailToDelete'];
    ...
    $sql="delete from customer where username ='$name' && email='$email'";
...
$sql = "UPDATE customer SET username='$newusername', email='$email', password='$password' WHERE username='$oldusername'";
$qry = mysqli_query($con,$sql);//run query
return $qry;  //return query
}
?>