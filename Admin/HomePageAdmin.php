...
<nav>
  <ul>
    <li><a href="#">Home</a></li>
    <li><a href="../Profile/viewprofileadmin.php">Profile</a></li>
    <li><a href="aboutusadmi.html">About</a></li>
    <li><a href="listcontactusadmin.php">Contact Us</a></li>
	<li><a href="addstaff.html">Add Staff</a></li>
    <li><a href="addmovie.html">Add Movie</a></li>
	 <li><a href="addpromo.html">Add Promotion</a></li>
	<li><a href="addmenu.php">Add Menu</a></li>
    <li><a href="viewcustomer.php">View Customer</a></li>
	<li><a href="viewstaff.php">View Staff</a></li>
	<li><a href="viewmovie.php">View Movie</a></li>
	<li><a href="viewpromo.php">View Promotion</a></li>
	<li><a href="viewmenu.php">View Menu</a></li>
	<li><a href="viewseat.php">View Seat</a></li>
	<li><a href="viewbookingadmin.php">View Booking</a></li>
...
while ($row = mysqli_fetch_assoc($qry)) {
  ...
  echo '<form action="viewmoviedetailadmin.php" method="POST" >';
