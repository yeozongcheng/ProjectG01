...
<link rel="stylesheet" href="https://www.w3schools.com/w3css/4/w3.css">
    ...
    <body>
	    ...
	    $qry = getListOfPromo();//display all car
                ...
                //delete menu
                        echo '<td>';
			            echo '<form action="../Admin/processpromo.php" method="POST" >';
				...
				//updaate menu
				        echo '<td>';
			            echo '<form action="updatePromoFormStaff.php" method="post" >';
			            echo "<input type='hidden' value='$id' name='idToUpdate'>";
			            echo '<input type="submit" name="updateMovieButtonStaff" value="Update">';
			            echo '</form>';
                        echo '</td>';
